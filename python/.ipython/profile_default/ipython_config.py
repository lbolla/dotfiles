...
# The name of a Pygments style to use for syntax highlighting:  paraiso-dark,
# pastie, trac, perldoc, vim, borland, algol_nu, default, xcode, monokai,
# native, vs, algol, bw, friendly, emacs, lovelace, fruity, igor, tango, rrt,
# colorful, manni, paraiso-light, autumn, murphy

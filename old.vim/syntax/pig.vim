...
syn keyword pigKeyword  load store filter foreach order arrange distinct limit
...
syn keyword pigFunctionName BinStorage PigStorage TextLoader PigDump CassandraStorage IsEmpty contained

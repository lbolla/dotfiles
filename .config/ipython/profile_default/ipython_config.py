...
# variable IPYTHONDIR.
# c.TerminalIPythonApp.ipython_dir = u'/home/lbolla/.config/ipython'
...
# c.TerminalInteractiveShell.banner1 = 'Python 2.7.3 (default, Jan  2 2013, 13:56:14) \nType "copyright", "credits" or "license" for more information.\n\nIPython 0.13.2 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
c.TerminalIPythonApp.extensions = []
for pkg in ['line_profiler', 'memory_profiler']:
    try:
        __import__(pkg)
        c.TerminalIPythonApp.extensions.append(pkg)
    except ImportError:
        pass

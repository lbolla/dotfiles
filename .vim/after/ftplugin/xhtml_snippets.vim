...
exec "Snippet utf8 <meta http-equiv=\"Content-type\" content=\"text/html; charset=utf-8\" />".st.et
...
exec "Snippet table <table summary=\"".st."Summary".et."\" class=\"".st."className".et."\"><CR>".st.et."<CR></table>".st.et
...
exec "Snippet img   <img src=\"".st.et."\" alt=\"".st.et."\" title=\"".st.et."\" />".st.et
exec "Snippet input <input name=\"".st.et."\" id=\"".st.et."\" type=\"".st.et."\" value=\"".st."defaultValue".et."\" />".st.et

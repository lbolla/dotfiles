...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "F11", function () awful.spawn(xrandr_cmd) end,
              {description = "reset monitors", group = "launcher"}),
    awful.key({ modkey,           }, "F12", function () awful.spawn("gscreenshot-cli -s -o -f /tmp/") end,

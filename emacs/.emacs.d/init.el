...
(custom-set-variables
 ...
 '(fill-column 79)
 '(flycheck-check-syntax-automatically '(save idle-change new-line mode-enabled) t)
 '(flycheck-clang-include-path
   '("/usr/include/glib-2.0" "/usr/lib/x86_64-linux-gnu/glib-2.0/include" "../deps" "../../deps") t)
 '(flycheck-clang-language-standard "c++11" t)
 '(flycheck-cppcheck-checks '("all") t)
 '(flycheck-cppcheck-suppressions '("constStatement") t)
 '(flycheck-flake8rc "setup.cfg" t)
 '(flycheck-gcc-language-standard "c++1y" t)
 '(flycheck-ghc-language-extensions nil t)
 '(flycheck-highlighting-mode 'lines t)
